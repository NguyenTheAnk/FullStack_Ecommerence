                ...
                <div className="box card p-3 shadow border-0">
                    ...
                    <form className="mt-3" onSubmit={register}>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <TextField label="Name" name="name" type="text" onChange={onchangeInput} variant="standard" className="w-100"/>   
                                </div>
                            </div>
                            <div className="col-md-6">
                                 <div className="form-group">
                                    <TextField label="Phone No." name="phone" type="text" onChange={onchangeInput} variant="standard" className="w-100"/>   
                                </div>
                            </div>
                        </div>

                        <div className="form-group">
                            <TextField id="standard-basic" label="Email" name="email" type="email" onChange={onchangeInput} variant="standard" className="w-100"/>   
                        </div>
                        <div className="form-group">
                            <TextField id="standard-basic" label="Password" name="password" type="password" onChange={onchangeInput} variant="standard" className="w-100"/>   
                        </div>
                        ...
                        <div className="d-flex align-items-center mt-3 mb-3">
                            <Button type="submit" disabled={isLoading===true ? true : false} className="btn-blue col btn-lg btn-big">
                                {
